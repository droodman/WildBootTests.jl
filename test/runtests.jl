...
open("unittests.log", "w") do log  # use Github Desktop to detect changes in output
  ...
  println(log, wildboottest(T, T[0 0 0 1]  , T[.04]; resp, predexog,      clustid=idcoarse))
  println(log, wildboottest(T, T[0 0 0 1]  , T[.04]; resp, predexog, rng, clustid=idgranular))
  ...
  println(log, wildboottest(T, T[0 0 0 1 0], T[.04]; resp, predexog, predendog, inst, rng, clustid=idgranular, liml=true))
  println(log, wildboottest(    [0 0 0 1]  , [0]   ; resp, predexog,      clustid=idcoarse))
  println(log, wildboottest(    [0 0 0 1]  , [0]   ; resp, predexog, rng, clustid=idgranular))
  ...
  println(log, wildboottest(    [0 0 0 1 0], T[.04]; resp, predexog, predendog, inst, rng, clustid=idgranular, liml=true))
  println(log, wildboottest(    [0 0 0 1]  , [0]   ; resp, predexog, jk=true,      clustid=idcoarse))
  println(log, wildboottest(    [0 0 0 1]  , [0]   ; resp, predexog, jk=true, rng, clustid=idgranular))
  ...
  println(log, wildboottest(    [0 0 0 0 1], T[.04]; resp, predexog, jk=true, predendog, inst, rng, clustid=idgranular, obswt=resp, arubin=true))
  println(log, wildboottest(    [0 0 0 1 0], T[.04]; resp, predexog, jk=true, predendog, inst, rng, clustid=idgranular, liml=true))
