...
# 		o.invZperpZperpS✻ZperpUv = isone(o.Nw) ? [Matrix{T}(undef, o.DGP.kZperp, ncols(o.v))] :
# 	                                            [Matrix{T}(undef, o.DGP.kZperp, length(o.WeightGrp[1])), Matrix{T}(undef, o.DGP.kZperp, length(o.WeightGrp[end]))]
# 		o.S✻ZperpUv  = deepcopy(o.invZperpZperpS✻ZperpUv)
# 		if o.NFE>0 & !o.FEboot
# 			o.CT✻FEUv = isone(o.Nw) ? [Matrix{T}(undef, o.NFE, ncols(o.v))] :
# 	                               [Matrix{T}(undef, o.NFE, length(o.WeightGrp[1])), Matrix{T}(undef, o.NFE, length(o.WeightGrp[end]))]
# 			o.invFEwtCT✻FEUv = deepcopy(o.CT✻FEUv)
# 		end
...
# 			if isone(o.Nw)
# 				o.PXY✻  = isone(o.Nw) ? [Matrix{T}(undef, o.Nobs, ncols(o.v))] :
# 		                             [Matrix{T}(undef, o.Nobs, length(o.WeightGrp[1])), Matrix{T}(undef, o.Nobs, length(o.WeightGrp[end]))]
# 				o.S✻UMZperpv = deepcopy(o.PXY✻)
# 			end
# 		end
# 	else
# 		o.Repl.Zperp = o.DGP.Zperp = Matrix{T}(undef,0,0)  # drop this potentially large array
...
# 					coldot!(dest, row, T1L, T1R)
# 				else
# 					tmul!(view(dest,row,:), T1L', view(o.Repl.V,:,j))  # coldot!(dest, row, T1L, view(o.Repl.V,:,j))
# 				end
# 			else
# 				if o.Repl.Yendog[j+1]
# 					T1R = o.T1R[_w]  # use preallocated destinations
...
# 						T1R .+= view(o.Repl.V,:,j)
# 					end
# 					tmul!(view(dest,row,:), T1R', view(o.Repl.XZ,:,i))
# 				else
# 					dest[row,:] .= dot(view(o.Repl.V,:,j), view(o.Repl.XZ,:,i))
# 				end
# 			end
...
# 		# 			_β̈ = view(β̈s,j,:)'
# 		# 			o.β̈v[_w] .= o.v .* _β̈ 
# 		# 			panelcoldotminus!(dest, (o.Repl.Yendog[j+1] ? view(o.Repl.Z,:,j) * _β̈ .- view(o.S✻UMZperp,:,:,j+1) * o.β̈v[_w] :
# 		# 																									  view(o.Repl.Z,:,j) * _β̈                                           ), o.PXY✻[_w], o.info⋂)
# 		# 		end
# 		# 	else
# 		# 		PXY✻ = view(o.PXZ,:,i)
...
# 		# 			_β̈ = view(β̈s,j,:)'
# 		# 			o.β̈v[_w] .= o.v .* _β̈ 
# 		# 			panelsumminus!(dest, (o.Repl.Yendog[j+1] ? view(o.Repl.Z,:,j) * _β̈ .- view(o.S✻UMZperp,:,:,j+1) * o.β̈v[_w] :
# 		# 																								 view(o.Repl.Z,:,j) * _β̈                                           ), PXY✻, o.info⋂)
# 		# 		end
# 			end
# 		else  # create pieces of each N x B matrix one at a time
# 			_β̈ = Matrix{T}(undef,0,0)
# 			@inbounds for j ∈ 0:o.Repl.kZ
# 				j>0 && (o.β̈v[_w] = o.v .* (_β̈ = view(β̈s,j,:)'))
