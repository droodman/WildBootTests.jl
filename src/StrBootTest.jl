...
mutable struct StrBootTest{T<:AbstractFloat}
  ...
  seed::UInt64
	...
	S✻uy₁0::Array{T,3}; ∂S✻uy₁∂β̂::Array{T,3}; ∂S✻uy₁∂γ̈::Array{T,3}; ∂S✻uy₁∂γ̈Π̂::Array{T,3}; ∂S✻uy₁∂r::Array{T,3}
_ID✻⋂::Vector{Int}
